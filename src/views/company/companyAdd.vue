                ...
                <div id="weui-cells-flex" class="weui-cells" style="">
                    <van-cell-group>
                        <van-form>
                            ...
                            <van-cell-group v-show="state.stock.shareholder0 && state.stock.ratioDetail0 && state.stock.ratioDetail0 < 100 " style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder2 && state.stock.ratioDetail2 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0  + state.stock.ratioDetail2 * 1.0 ) < 100 " style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder3 && state.stock.ratioDetail3 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder4 && state.stock.ratioDetail4 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder5 && state.stock.ratioDetail5 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder6 && state.stock.ratioDetail6 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder7 && state.stock.ratioDetail7 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder8 && state.stock.ratioDetail8 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 + state.stock.ratioDetail8 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder9 && state.stock.ratioDetail9 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 + state.stock.ratioDetail8 * 1.0 + state.stock.ratioDetail9 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder10 && state.stock.ratioDetail10 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 + state.stock.ratioDetail8 * 1.0 + state.stock.ratioDetail9 * 1.0 + state.stock.ratioDetail10 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder11 && state.stock.ratioDetail11 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 + state.stock.ratioDetail8 * 1.0 + state.stock.ratioDetail9 * 1.0 + state.stock.ratioDetail10 * 1.0 + state.stock.ratioDetail11 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder12 && state.stock.ratioDetail12 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 + state.stock.ratioDetail8 * 1.0 + state.stock.ratioDetail9 * 1.0 + state.stock.ratioDetail10 * 1.0 + state.stock.ratioDetail11 * 1.0 + state.stock.ratioDetail12 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder13 && state.stock.ratioDetail13 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 + state.stock.ratioDetail8 * 1.0 + state.stock.ratioDetail9 * 1.0 + state.stock.ratioDetail10 * 1.0 + state.stock.ratioDetail11 * 1.0 + state.stock.ratioDetail12 * 1.0 + state.stock.ratioDetail13 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder14 && state.stock.ratioDetail14 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 + state.stock.ratioDetail8 * 1.0 + state.stock.ratioDetail9 * 1.0 + state.stock.ratioDetail10 * 1.0 + state.stock.ratioDetail11 * 1.0 + state.stock.ratioDetail12 * 1.0 + state.stock.ratioDetail13 * 1.0 + state.stock.ratioDetail14 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder15 && state.stock.ratioDetail15 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 + state.stock.ratioDetail8 * 1.0 + state.stock.ratioDetail9 * 1.0 + state.stock.ratioDetail10 * 1.0 + state.stock.ratioDetail11 * 1.0 + state.stock.ratioDetail12 * 1.0 + state.stock.ratioDetail13 * 1.0 + state.stock.ratioDetail14 * 1.0 + state.stock.ratioDetail15 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder16 && state.stock.ratioDetail16 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 + state.stock.ratioDetail8 * 1.0 + state.stock.ratioDetail9 * 1.0 + state.stock.ratioDetail10 * 1.0 + state.stock.ratioDetail11 * 1.0 + state.stock.ratioDetail12 * 1.0 + state.stock.ratioDetail13 * 1.0 + state.stock.ratioDetail14 * 1.0 + state.stock.ratioDetail15 * 1.0 + state.stock.ratioDetail16 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder17 && state.stock.ratioDetail17 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 + state.stock.ratioDetail8 * 1.0 + state.stock.ratioDetail9 * 1.0 + state.stock.ratioDetail10 * 1.0 + state.stock.ratioDetail11 * 1.0 + state.stock.ratioDetail12 * 1.0 + state.stock.ratioDetail13 * 1.0 + state.stock.ratioDetail14 * 1.0 + state.stock.ratioDetail15 * 1.0 + state.stock.ratioDetail16 * 1.0 + state.stock.ratioDetail17 * 1.0 ) < 100" style="margin-top:10px;">
                            ...
                            <van-cell-group v-show="state.stock.shareholder18 && state.stock.ratioDetail18 && (state.stock.ratioDetail0 * 1.0 + state.stock.ratioDetail1 * 1.0 + state.stock.ratioDetail2 * 1.0 + state.stock.ratioDetail3 * 1.0 + state.stock.ratioDetail4 * 1.0 + state.stock.ratioDetail5 * 1.0 + state.stock.ratioDetail6 * 1.0 + state.stock.ratioDetail7 * 1.0 + state.stock.ratioDetail8 * 1.0 + state.stock.ratioDetail9 * 1.0 + state.stock.ratioDetail10 * 1.0 + state.stock.ratioDetail11 * 1.0 + state.stock.ratioDetail12 * 1.0 + state.stock.ratioDetail13 * 1.0 + state.stock.ratioDetail14 * 1.0 + state.stock.ratioDetail15 * 1.0 + state.stock.ratioDetail16 * 1.0 + state.stock.ratioDetail17 * 1.0 + state.stock.ratioDetail18 * 1.0 ) < 100 " style="margin-top:10px;">
