...
<keep-alive>
    ...
    <div id="content" style="margin-top: 0px; overflow-x: hidden;">
        ...
        <header id="wx-header">
            <van-nav-bar title="补贴记录" left-text="返回" left-arrow @click-left="returnBack" @click-right="searching">
                <template #right>
        ...
        <div class="section-content" style="">
            <section class="section" style="box-shadow: 0 0.13333rem 0.2rem 0 rgb(0 0 0 / 10%);">
                <div id="weui-cells-flex" class="weui-cells" style="">
                    <div class="weui-cell-title" style="">补贴管理</div>
                    <div class="flex-layout-content" id="scanCell" style="">
                        <van-row>
                            <van-col span="6">
                                ...
                                <div class="section-flex-layout-content" style="">新增补贴</div>
                            </van-col>
                        </van-row>
                    </div>
                </div>
...
export default {
    ...
    setup(props, context) {
        ...
        const state = reactive({
            imgs: [
                'https://cdn.jsdelivr.net/gh/Miazzy/xdata-stock-service@v1.0.5/src/assets/img/cunkuanqukuan.png',//
            ],
        });
