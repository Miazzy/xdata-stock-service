...
<keep-alive>
    ...
    <div id="content" style="margin-top: 0px; overflow-x: hidden;">
        ...
        <header id="wx-header">
            <van-nav-bar title="账号管理" left-text="返回" left-arrow @click-left="returnBack" @click-right="searching">
                <template #right>
        ...
        <div class="section-content" style="">
            <section class="section" style="box-shadow: 0 0.13333rem 0.2rem 0 rgb(0 0 0 / 10%);">
                <div id="weui-cells-flex" class="weui-cells" style="">
                    <div class="weui-cell-title" style="">账号管理</div>
                    <div class="flex-layout-content" id="scanCell" style="">
                        <van-row>
                            <van-col span="6">
                                ...
                                <div class="section-flex-layout-content" style="">新增账号</div>
                            </van-col>
                            <van-col span="6">
                                <van-badge>
                                    <img class="child" style="" :src="state.imgs[1]">
                                </van-badge>
                                <div class="section-flex-layout-content" style="">修改账号</div>
                            </van-col>
                            <van-col span="6">
                                <van-badge>
                                    <img class="child" style="" :src="state.imgs[2]">
                                </van-badge>
                                <div class="section-flex-layout-content" style="">删除账号</div>
                            </van-col>
                            <van-col span="6">
                                <van-badge>
                                    <img class="child" style="" :src="state.imgs[3]">
                                </van-badge>
                                <div class="section-flex-layout-content" style="">禁用账号</div>
                            </van-col>
                        </van-row>
                    </div>
                </div>
