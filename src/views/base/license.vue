...
<keep-alive>
    ...
    <div id="content" style="margin-top: 0px; overflow-x: hidden;">
        ...
        <header id="wx-header">
            <van-nav-bar title="项目证照" left-text="返回" left-arrow @click-left="returnBack" @click-right="searching">
                <template #right>
                    ...
                    <div class="flex-layout-content" id="scanCell" style="">
                        <van-row>
                            ...
                            <van-col span="6">
                                ...
                                <div class="section-flex-layout-content" style="">修改证照</div>
                            </van-col>
                            <van-col span="6">
                                <van-badge>
                                    <img class="child" style="" :src="state.imgs[1]">
                                </van-badge>
                                <div class="section-flex-layout-content" style="">隐藏证照</div>
                            </van-col>
                        </van-row>
                    </div>
                </div>
